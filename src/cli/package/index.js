...
module.exports = command(
  ...
  async argv => {
    ...
    console.log('DIRNAME', resolve(root, 'src/main.ts'));
    // If we call build without any config it seems to use the project root vite.config.js
    // Which is probably what we want. Build it when creating the project
    await build({
      // root: resolve(
      // __dirname, './'),
      // base: '/',
